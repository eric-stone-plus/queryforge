...
You're reviewing QueryForge — a Text-to-SQL data analysis agent built for a hackathon. The project is in the repository root. It uses Next.js, an OpenAI-compatible LLM endpoint, better-sqlite3, and recently migrated from generated demo data to the Olist Brazilian e-commerce dataset (99K real orders).
...
Write your analysis to debates/quinte/round4-final-direction/r1-codex.md
